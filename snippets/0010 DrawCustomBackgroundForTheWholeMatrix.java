...
public class Snippet_0010 {
	...
	// Meta data
	static final String title = "Draw custom background for the whole matrix";
	static final String instructions = "Move the mouse over the matrix and watch the background changing";
