 ...
 */
public class _0410_SeparateZoneToInsertNewItems {
  ...
  ArrayList<Object[]> data;
	...
	public static void main(String[] args) throws IOException {
		...
		new _0410_SeparateZoneToInsertNewItems(shell);
  ...
  public _0410_SeparateZoneToInsertNewItems(Composite parent) {
		// Data model
    ...
    new ZoneEditor<Integer, Integer>(insertHeader) {
      ...
      @Override protected void setBounds(Integer indexX, Integer indexY, Control control) {
    ...
    final Matrix<Integer, Integer> matrix;
      ...
      super(matrix.getZone(matrix.getAxisX().getBody(), matrix.getAxisY().getSection(2)));
      this.matrix = matrix;
