...
public class S0013_GapBetweenCellsLikeHTMLTableCellspacingAttribute_HideLines {
  public static void main(String[] args) {
    ...
    columnHeader.getPainter(Painter.NAME_CELLS).style.background = null;
    ...
    columnHeader.addPainter(0, new Painter<Integer, Integer>(
      "cell background and border", Painter.SCOPE_CELLS) {
      @Override
    ...
    body.addPainter(new Painter<Integer, Integer>("cell border",
      Painter.SCOPE_CELLS) {
      @Override
      public void paint(int x, int y, int width, int height) {
