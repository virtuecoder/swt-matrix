 ...
 */
public class S0902_SelectionAndControlEventHandling {
  public static void main(String[] args) {
    Shell shell = new Shell();
    shell.setText(title);
    shell.setLayout(new FillLayout());

    Matrix<Integer, Integer> matrix = new Matrix<Integer, Integer>(shell, SWT.H_SCROLL);
    ...
    bodyX.addControlListener(new ControlAdapter() {
      ...
      public void controlResized(ControlEvent e) {
        ...
        System.out.println("New size: " + section.getCellWidth(item.getIndex()));
      }
      ...
      public void controlMoved(ControlEvent e) {
        ...
        @SuppressWarnings("unchecked") AxisItem<Integer> item = (AxisItem<Integer>) e.data;
        System.out.println("Target: section " + item.getSection() + ", index "
          + item.getIndex());
      }
    });
