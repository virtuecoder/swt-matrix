 ...
 */
/*
 * Can also copy/paste irregular sets of selected cells, e.g. (0,0) and (1,1)
 * cells at once.
 */
public class S0490_CustomCopy_Paste {
  ...
  public static void main(String[] args) {
    ...
    final ZoneEditor<Integer, Integer> zoneEditor = new ZoneEditor<Integer, Integer>(
      matrix.getBody()) {
      @Override
      ...
      public void copy() {
        ...
        if (body.getSelectedCount().compareTo(BigInteger.ZERO) == 0) {
          ...
          CellExtent<Integer, Integer> n = body.getSelectedExtent();
