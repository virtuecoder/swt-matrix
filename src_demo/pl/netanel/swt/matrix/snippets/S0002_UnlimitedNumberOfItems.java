 ...
 */
public class S0002_UnlimitedNumberOfItems {
  public static void main(String[] args) {
    ...
    Matrix<Integer, BigInteger> matrix = 
      new Matrix<Integer, BigInteger>(shell, SWT.V_SCROLL | SWT.H_SCROLL, null, axisY);
    ...
    matrix.getAxisY().getBody()
      .setCount(new BigInteger("123456789012345678901234567890"));
