...
public class SpanExtentSequenceTest {
  private SpanExtentSequence<Integer> seq;
  ...
  public void _0_00() throws Exception {
    seq = new SpanExtentSequence<Integer>(set, 0, 0);
    seq.init();
  ...
  public void _0_01() throws Exception {
    seq = new SpanExtentSequence<Integer>(set, 0, 1);
    seq.init();
    assertFalse(seq.next());
  }
  ...
  public void _0__11() throws Exception {
    seq = new SpanExtentSequence<Integer>(set, -1, 1);
    seq.init();
    assertFalse(seq.next());
  }
  ...
  public void _1_02() throws Exception {
    set.add(0);
    seq = new SpanExtentSequence<Integer>(set, 0, 2);
    seq.init();
    assertTrue(seq.next());
    assertEquals("0-0", seq.current.toString());
    assertFalse(seq.next());
  ...
  public void _3_12() throws Exception {
    set.add(0, 2);
    seq = new SpanExtentSequence<Integer>(set, 1, 2);
    seq.init();
    assertTrue(seq.next());
  ...
  public void _10_2() throws Exception {
    ...
    // 0-1, 5-6, 2-4, 7-9
    seq = new SpanExtentSequence<Integer>(set, 1, 5);
    seq.init();
    assertTrue(seq.next());
