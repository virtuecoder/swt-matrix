 ...
 *
 * @param <X>
 *          indexing type for the horizontal axis
 * @param <Y>
 *          indexing type for vertical axis
 */
...
//	}
	 ...
	 * @param axisY
	 *          vertical axis for the matrix
	 * @param axisX
	 *          horizontal axis for the matrix
	 *
...
//  		updateScrollBars();
	 ...
	 *
	 * @param sectionX
	 *          section of the horizontal axis
	 * @param sectionY
	 *          section of the vertical axis
	 *
	 * @return zone located at the intersection of the given axis sections
	 * @throws IllegalArgumentException
	 *           if item is <code>null</code> or section does not belong to an
	 *           axis of this matrix.
	 */
	public Zone<X, Y> getZone(Section<X> sectionX, Section<Y> sectionY) {
		for (ZoneClient<X, Y> zone : zones) {
			if (zone.sectionX.core.equals(axisX.checkSection(sectionX, "sectionX"))
					&& zone.sectionY.core
							.equals(axisY.checkSection(sectionY, "sectionY"))) {
				return zone;
			}
		}
		return null;
	 ...
	 *
	 * @param state
	 *          the new focus cell enablement state
	 */
	 ...
	 *
	 * @param index
	 *          at which the specified painter is to be inserted
	 * @param painter
	 ...
	 *
	 * @param state
	 *          the new state for the "select hidden cells" property
	 */
	 ...
	 *
	 * @param state
	 *          the new state for the "copy paste beyond body" property
	 */
