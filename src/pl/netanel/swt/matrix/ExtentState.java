...
/**
 * Base class for storing one values for a set of indexes.
 */
abstract class ExtentState<N extends Number> {
	final Math<N> math;
	final ArrayList<MutableExtent<N>> extents;
	private final IntArray toRemove;


	public ExtentState(Math<N> math) {
		this.math = math;
